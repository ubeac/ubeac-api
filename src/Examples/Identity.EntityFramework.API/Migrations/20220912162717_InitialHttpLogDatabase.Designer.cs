...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("uBeac.Web.Logging.EntityFramework.EFHttpLog2xx", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("HttpLogs2xx");
                });

            modelBuilder.Entity("uBeac.Web.Logging.EntityFramework.EFHttpLog4xx", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("HttpLogs4xx");
                });

            modelBuilder.Entity("uBeac.Web.Logging.EntityFramework.EFHttpLog5xx", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("uBeac.Web.Logging.EntityFramework.EFHttpLog2xx", b =>
                {
                    b.OwnsOne("uBeac.Web.Logging.ExceptionModel", "Exception", b1 =>
                        {
                            b1.Property<Guid>("EFHttpLog2xxId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("EFHttpLog2xxId");

                            b1.ToTable("HttpLogs2xx");

                            b1.WithOwner()
                                .HasForeignKey("EFHttpLog2xxId");
                        });
            ...
            modelBuilder.Entity("uBeac.Web.Logging.EntityFramework.EFHttpLog4xx", b =>
                {
                    b.OwnsOne("uBeac.Web.Logging.ExceptionModel", "Exception", b1 =>
                        {
                            b1.Property<Guid>("EFHttpLog4xxId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("EFHttpLog4xxId");

                            b1.ToTable("HttpLogs4xx");

                            b1.WithOwner()
                                .HasForeignKey("EFHttpLog4xxId");
                        });
            ...
            modelBuilder.Entity("uBeac.Web.Logging.EntityFramework.EFHttpLog5xx", b =>
                {
                    b.OwnsOne("uBeac.Web.Logging.ExceptionModel", "Exception", b1 =>
                        {
                            b1.Property<Guid>("EFHttpLog5xxId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("EFHttpLog5xxId");

                            b1.ToTable("HttpLogs5xx");

                            b1.WithOwner()
                                .HasForeignKey("EFHttpLog5xxId");
                        });
